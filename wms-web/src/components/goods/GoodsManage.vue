<template>
  <div>
    ...
    <el-table v-loading="list_loading"
      ...
      <el-table-column prop="storage" label="物品类型" sortable width="130"></el-table-column>
      <el-table-column prop="goodstype" label="仓库" sortable width="180"></el-table-column>
      <el-table-column prop="count" label="数量" sortable width="80"></el-table-column>
      <el-table-column prop="remark" label="备注" sortable width="300"></el-table-column>
